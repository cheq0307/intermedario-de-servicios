...
return [
    ...
    'publication_draft_days' => (int) env('MARKETPLACE_PUBLICATION_DRAFT_DAYS', 30),
    'negotiation_days' => (int) env('MARKETPLACE_NEGOTIATION_DAYS', 7),
    'negotiation_max_extensions' => (int) env('MARKETPLACE_NEGOTIATION_MAX_EXTENSIONS', 1),
    'negotiation_extension_window_days' => (int) env('MARKETPLACE_NEGOTIATION_EXTENSION_WINDOW_DAYS', 2),
    'negotiation_retention_months' => (int) env('MARKETPLACE_NEGOTIATION_RETENTION_MONTHS', 3),
