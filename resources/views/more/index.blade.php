...
<main class="mx-auto max-w-3xl px-4 py-7 sm:px-6">
    ...
    <section class="mt-5 overflow-hidden rounded-[2rem] border border-[#123B4A]/10 bg-white shadow-sm">
        ...
        <div class="border-b px-6 py-4">
            <div class="flex items-center gap-4"><span class="grid size-10 place-items-center rounded-full bg-[#FFF8E6]"><svg class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="7" width="18" height="12" rx="2"/><path d="M8 7V4h8v3M3 12h18"/></svg></span><div><strong class="block">Empleo</strong><span class="text-xs font-semibold text-[#6B7D83]">Busca trabajo, publica vacantes o revisa postulaciones.</span></div></div>
            <div class="mt-4 grid gap-2 sm:grid-cols-3">
                <a class="rounded-2xl bg-[#FAF8F4] px-4 py-3 text-sm font-black hover:bg-[#E9F7F0]" href="{{ route('vacancies.index') }}">Buscar empleo <span class="float-right">›</span></a>
                <a class="rounded-2xl bg-[#FAF8F4] px-4 py-3 text-sm font-black hover:bg-[#E9F7F0]" href="{{ route('vacancies.create') }}">Publicar vacante <span class="float-right">›</span></a>
                <a class="rounded-2xl bg-[#FAF8F4] px-4 py-3 text-sm font-black hover:bg-[#E9F7F0]" href="{{ route('vacancies.mine') }}">Mis vacantes y postulaciones <span class="float-right">›</span></a>
            </div>
        </div>
