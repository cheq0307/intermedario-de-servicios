<x-admin-layout title="Centro de operación" section="center" :unread-count="$metrics['unread_notifications']" :pending-count="$metrics['pending_vendors']">
        ...
        <section class="mt-7 grid gap-4 grid-cols-2 md:grid-cols-3 xl:grid-cols-6">
            <a class="rounded-3xl border border-brand-orange/20 bg-white p-5 shadow-sm transition hover:-translate-y-0.5" href="{{ route('admin.users.index', ['commercial_status' => 'pending']) }}"><strong class="text-3xl">{{ $metrics['pending_vendors'] }}</strong><p class="mt-2 text-sm font-bold text-brand-muted">Cuentas por verificar</p><span class="mt-3 block text-xs font-black text-brand-danger-warm">Revisar →</span></a>
            <a class="rounded-3xl border border-brand/10 bg-white p-5 shadow-sm transition hover:-translate-y-0.5" href="{{ route('disputes.admin-index') }}"><strong class="text-3xl">{{ $metrics['open_disputes'] }}</strong><p class="mt-2 text-sm font-bold text-brand-muted">Disputas abiertas</p><span class="mt-3 block text-xs font-black text-brand-success">Atender →</span></a>
            <a class="rounded-3xl border border-brand/10 bg-white p-5 shadow-sm transition hover:-translate-y-0.5" href="{{ route('admin.support.index') }}"><strong class="text-3xl">{{ $metrics['open_support_tickets'] }}</strong><p class="mt-2 text-sm font-bold text-brand-muted">Casos de soporte</p><span class="mt-3 block text-xs font-black text-brand-success">Responder →</span></a>
            <a class="rounded-3xl border border-brand/10 bg-white p-5 shadow-sm transition hover:-translate-y-0.5" href="{{ route('admin.operations.index') }}"><strong class="text-3xl">{{ $metrics['active_orders'] }}</strong><p class="mt-2 text-sm font-bold text-brand-muted">Operaciones activas</p><span class="mt-3 block text-xs font-black text-brand-success">Supervisar →</span></a>
            <a class="rounded-3xl border border-brand/10 bg-white p-5 shadow-sm transition hover:-translate-y-0.5" href="{{ route('admin.users.index') }}"><strong class="text-3xl">{{ $metrics['users'] }}</strong><p class="mt-2 text-sm font-bold text-brand-muted">Cuentas registradas</p><span class="mt-3 block text-xs font-black text-brand-success">Abrir directorio →</span></a>
            <a class="rounded-3xl border border-brand/10 bg-white p-5 shadow-sm transition hover:-translate-y-0.5" href="{{ route('admin.posts.index') }}"><strong class="text-3xl">{{ $metrics['active_posts'] }}</strong><p class="mt-2 text-sm font-bold text-brand-muted">Publicaciones activas</p><span class="mt-3 block text-xs font-black text-brand-success">Moderar →</span></a>
        </section>
        ...
        <section class="mt-8 rounded-[1.75rem] border border-brand-orange/20 bg-white p-5 shadow-sm sm:p-6" id="bandeja-operativa">
            ...
            <div class="mt-5 grid gap-3 md:grid-cols-3">
                ...
                <a class="rounded-2xl bg-brand-surface p-4" href="{{ route('disputes.admin-index') }}"><strong>{{ $metrics['open_disputes'] }} disputas abiertas</strong><span class="mt-2 block text-xs font-black text-brand-success">Atender casos →</span></a>
                <a class="rounded-2xl bg-brand-surface p-4" href="{{ route('admin.support.index') }}"><strong>{{ $metrics['open_support_tickets'] }} casos de soporte</strong><span class="mt-2 block text-xs font-black text-brand-success">Responder →</span></a>
            </div>
        </section>
